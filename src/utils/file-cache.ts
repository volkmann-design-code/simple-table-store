...
const maxMemoryBytes = parseInt(process.env.FILE_CACHE_MAX_MEMORY_BYTES || '104857600', 10); // Default 100MB
...
export async function getCachedFile(objectKey: string): Promise<{ body: Buffer; contentType: string } | null> {
